Sprint 01 – Circuito Lógico com Expressão Booleana e Tabela Verdade

Disciplina:

COMPUTER SCIENCECurso: Ciências da Computação – 1º Ano

Turma: [1CCPH]Entrega: Sprint 01 – Circuito Lógico com Expressão Booleana e Tabela VerdadeEquipe: [Nome da Equipe]Integrantes: [Nome dos alunos]Desafio: [Nome do Challenge ou título do projeto]
...
Representação gráfica do circuito utilizando portas lógicas (AND, OR, NOT, etc.)
